...
String allSensorsOutputFile=currentDirectory+"log.csv";
...
//  File configFile, dataFile;
  ...
  else
  {
    ...
    if(outputFileLocation!=null)
        allSensorsOutputFile=outputFileLocation;
...
public boolean needsConfiguration(String[] splitMessage)
{
  Sensor a;
...
public void configure(String[] splitMessage)
{
  int tries=0;
  int response=-1;
...
public int listenForResponse(int timeout,int expectedResponse)
{
 ...
 * 
 */
public void addData(String[] splitMessage)
{
  Sensor mySensor;
  int i;
...
the file
*/
public void addColumn(String[] splitMessage)
{
...
*/
public void writeToAllSensors(String[] splitMessage)
{
  try{
...
public void keyPressed()  //if a key gets hit
{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#c0c0c0", "nublogger_cascabel" });
  }
}
